...
const PerspectivesSection = () => {
  return (
    <section className="section" style={{ backgroundColor: '#0F172A', padding: '5rem 5%' }}>
      <div className="news-header">
        <h2 style={{fontSize: '2.5rem', fontWeight: 800, color: '#FFFFFF'}}>Latest Perspectives</h2>
      ...
      <div className="grid-3">
        ...
        <div className="card" style={{boxShadow: 'none', background: 'transparent'}}>
          ...
          <div className="card-body" style={{padding: '1.5rem 0'}}>
            <span className="date-tag" style={{ color: 'var(--color-primary)' }}>September 28, 2024</span>
            <h3 className="card-title" style={{ color: '#FFFFFF', marginTop: '0.5rem', marginBottom: '0.5rem' }}>NTD Completes Phase 1 of Vision City Infrastructure</h3>
            <p className="card-text" style={{ color: '#94A3B8' }}>A milestone achievement in civil works, providing state-of-the-art road networks for th...</p>
          </div>
        </div>
        <div className="card" style={{boxShadow: 'none', background: 'transparent'}}>
          ...
          <div className="card-body" style={{padding: '1.5rem 0'}}>
            <span className="date-tag" style={{ color: 'var(--color-primary)' }}>August 12, 2024</span>
            <h3 className="card-title" style={{ color: '#FFFFFF', marginTop: '0.5rem', marginBottom: '0.5rem' }}>Digital Twins: Transforming Our On-Site Precision</h3>
            <p className="card-text" style={{ color: '#94A3B8' }}>Exploring how BIM and digital twin technology are reducing construction waste by 26% on ou...</p>
          </div>
        </div>
      </div>
    </section>
